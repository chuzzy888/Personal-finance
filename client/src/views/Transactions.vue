<!-- <template>
  <div class="md:bg-gray-50 md:p-10 josefin-font">
          ...
          <div class="flex items-center space-x-4">
            ...
            <div class="relative">
              ...
              >
                ...
                <button
                  @click="openConfirmationModal(transaction._id)"
                  class="block px-4 py-2 text-red-500 hover:bg-gray-100 w-full text-left"
                >
                  <i class="fa-solid fa-trash"></i>
                </button>
    ...
    addTransaction() {
      axiosInstance
        ...
        .then(() => {
          this.fetchTransactions();
          this.closeModal();
          this.showToastMessage("Transaction added successfully!");
        })
        .catch(error => {
          console.error("Error saving transaction:", error);
        });
    ...
    updateTransaction() {
      axiosInstance
        ...
        .then(() => {
          this.fetchTransactions();
          this.closeModal();
          this.showToastMessage("Transaction updated successfully!");
        })
        .catch(error => {
          console.error("Error updating transaction:", error);
        });
